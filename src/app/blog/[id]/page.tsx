...
const ARTICLES = [
  ...
  },
  {
    ...
    content: "Investir dans des équipements de qualité est une chose, mais garantir leur performance dans le temps en est une autre. Les Services Associés — regroupant la maintenance préventive, le support technique et le dépannage d'urgence — constituent le pilier invisible qui assure la longévité et l'efficacité de vos installations thermiques et de ventilation.\n\nUn contrat de maintenance régulier permet d'anticiper les pannes, d'optimiser la consommation énergétique et de conserver les garanties constructeur. Nos techniciens réalisent des visites programmées avec un bilan détaillé de l'état de vos équipements.\n\nLe support technique, accessible par hotline dédiée ou télémaintenance, offre une réactivité immédiate pour le diagnostic et le conseil. Enfin, notre service d'interventions d'urgence, disponible 7j/7, assure la continuité de votre activité avec des stocks de pièces de sécurité et des équipes d'astreinte mobilisables à tout moment.",
