                  ...
                  {isExpanded && (
                    <div className="mt-4 pl-10 pr-2 space-y-3.5 border-l-2 border-gray-100/80 animate-in fade-in duration-200">
                      <div className="grid grid-cols-3 gap-y-3 py-1 font-montserrat text-xs">
                        ...
                        <span className="text-gray-400 font-bold uppercase">Technique</span>
                        <span className="col-span-2 text-gray-900 font-semibold">{req.service}</span>

                        <span className="text-gray-400 font-bold uppercase">Budget</span>
                        <span className="col-span-2 text-gray-900 font-semibold">{req.budget}</span>

                        <span className="text-gray-400 font-bold uppercase">Localisation</span>
                        <span className="col-span-2 text-gray-900 font-semibold">{req.location}</span>
                        ...
                        <span className="text-gray-400 font-bold uppercase">Reçu le</span>
                        <span className="col-span-2 text-gray-500 font-semibold">{req.date}</span>
